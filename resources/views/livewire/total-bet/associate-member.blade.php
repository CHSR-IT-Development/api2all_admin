...
<div>
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title">Associate/Member</h4>
        </div>
        <div class="page-rightheader ml-auto d-lg-flex d-none">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Associate/Member</a></li>
            </ol>
        </div>
    </div>
    <div class="row">
                                ...
                                <table class="table table-bordered text-nowrap border" id="example1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><span>AG</span></th>
                                            <th class="text-center"><span>MA</span></th>
                                            <th class="text-center"><span>SR</span></th>
                                            <th class="text-center"><span>SSR</span></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
