...
<div>
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title">HDP & O/U</h4>
        </div>
        <div class="page-rightheader ml-auto d-lg-flex d-none">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">HDP & O/U</a></li>
            </ol>
        </div>
    </div>
    <div class="row">
                                ...
                                <table class="table table-bordered text-nowrap" id="example1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" colspan="6">FullTime</th>
                                            <th class="text-center" colspan="6">FirstHalf</th>
                                        </tr>
                                        <tr>
