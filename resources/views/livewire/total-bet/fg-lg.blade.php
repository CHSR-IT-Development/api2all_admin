    ...
    <div class="page-header">
        ...
        <div class="page-rightheader ml-auto d-lg-flex d-none">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">FG/LG</a></li>
            </ol>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="table-responsive">
                                <table class="table table-bordered text-nowrap" id="example1">
                                    <thead>
                                        <tr>
                                            <th class="text-center" rowspan="2" style="vertical-align: inherit;">Time</th>
                                            <th class="text-center" rowspan="2" style="vertical-align: inherit;">Teams</th>
                                            <th class="text-center" rowspan="2" style="vertical-align: inherit;">Bet List</th>
                                            <th class="text-center" colspan="2">First goal</th>
                                            <th class="text-center" colspan="2">Last goal</th>
                                            <th class="text-center" rowspan="2" style="vertical-align: inherit;">No Goal</th>
                                        </tr>
                                        <tr>
