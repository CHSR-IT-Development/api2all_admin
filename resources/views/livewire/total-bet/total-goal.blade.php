...
<div>
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title">Total goal</h4>
        </div>
        <div class="page-rightheader ml-auto d-lg-flex d-none">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Total goal</a></li>
            </ol>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="table-responsive">
                                <table class="table table-bordered text-nowrap" id="example1">
                                    <thead>
                                        <tr>
                                            <th class="text-center" rowspan="2" style="vertical-align: inherit;" width="100">Time</th>
                                            <th class="text-center" rowspan="2" style="vertical-align: inherit;" width="300">Teams</th>
                                            <th class="text-center" rowspan="2">Bet List</th>
                                            <th class="text-center" colspan="4">FullTime</th>
                                            <th class="text-center" colspan="3">FirstHalf</th>
                                        </tr>
                                        <tr>
                                            <th class="text-center">0-1</th>
                                            <th class="text-center">2-3</th>
                                            <th class="text-center">4-6</th>
                                            <th class="text-center">7 &amp; Over</th>

                                            <th class="text-center">0-1</th>
                                            <th class="text-center">2-3</th>
                                            <th class="text-center">4 &amp; Over</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
