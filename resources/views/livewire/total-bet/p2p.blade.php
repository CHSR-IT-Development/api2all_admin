    ...
    <div class="page-header">
        ...
        <div class="page-rightheader ml-auto d-lg-flex d-none">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">P2P</a></li>
            </ol>
        </div>
    </div>
    <div class="row">
                ...
                <div class="card-header bg-primary text-white">
                    ...
                    <div class="card-options">
                        <select name="country" id="select-countries" class="form-control custom-select select2 mr-3">
                            <option value="pl" data-data='{"image": "{{URL::asset('assets/images/flags/pl.svg')}}"}' selected>Le Gaming</option>
                        </select>
