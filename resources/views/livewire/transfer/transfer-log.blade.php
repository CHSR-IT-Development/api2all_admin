                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <select name="country" id="select-countries" class="form-control custom-select select2">
                                    <option value="pl" data-data='{"image": "{{URL::asset('assets/images/flags/pl.svg')}}"}' selected>Transfer</option>
                                    <option value="br" data-data='{"image": "{{URL::asset('assets/images/flags/br.svg')}}"}'>Running Transfer</option>
                                    <option value="cz" data-data='{"image": "{{URL::asset('assets/images/flags/cz.svg')}}"}'>Transfer Cash Withdraw</option>
                                    <option value="de" data-data='{"image": "{{URL::asset('assets/images/flags/de.svg')}}"}'>Transfer Cash Deposit</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-4">
                                ...
                                <table class="table table-bordered text-nowrap" id="example1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center wd-15p border-bottom-0">Datetime</th>
                                            <th class="text-center wd-15p border-bottom-0">IP</th>
                                            <th class="text-center wd-15p border-bottom-0">Created By</th>
                                            <th class="text-center wd-15p border-bottom-0">Amount</th>
                                        </tr>
                                    </thead>
                                    <tbody></tbody>
                                </table>
