                ...
                <div class="card-body">
                    ...
                    <div class="row">
                                ...
                                <table class="table table-bordered text-nowrap" id="example1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="wd-15p border-bottom-0">Credit Limit</th>
                                            <th class="wd-15p border-bottom-0">Total Outstanding</th>
                                            <th class="wd-15p border-bottom-0">Current Balance</th>
                                            <th class="wd-15p border-bottom-0">Yesterday Balance</th>
                                            <th class="wd-15p border-bottom-0">
                                                <input name="seclectAll" type="checkbox">
                                            </th>
                                            <th></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right text-danger"> -326.91</td>
                                            <td class="text-right"> -326.90</td>

                                            <td class="text-center">
                                                <input name="checkbox1" type="checkbox" class="ng-untouched ng-pristine ng-valid">
                                            </td>
                                            <td class="text-center">
                                                <a class="transfer-cash_icon fa fa-exchange" data-toggle="modal"></a>
                        ...
                        <div class="col-12 text-center mt-5">
                            <button class="btn btn-success" type="button">Transfer Yesterday</button>
                        </div>
                    </div>
                </div>
            </div>
