                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="form-group mt-4">
                                <select name="country" id="select-countries" class="form-control custom-select select2">
                                    <option value="pl" data-data='{"image": "{{URL::asset('assets/images/flags/pl.svg')}}"}' selected>--Currency--</option>
                                    <option value="br" data-data='{"image": "{{URL::asset('assets/images/flags/br.svg')}}"}'>AUD</option>
                                    <option value="cz" data-data='{"image": "{{URL::asset('assets/images/flags/cz.svg')}}"}'>CNY</option>
                                    <option value="de" data-data='{"image": "{{URL::asset('assets/images/flags/de.svg')}}"}'>USD</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-3">
                            <div class="form-group mt-4">
                                <select name="country" id="select-countries" class="form-control custom-select select2">
                                    <option value="pl" data-data='{"image": "{{URL::asset('assets/images/flags/pl.svg')}}"}' selected>--Task--</option>
                                    <option value="de" data-data='{"image": "{{URL::asset('assets/images/flags/de.svg')}}"}'>ADJ - ADJ</option>
                                    <option value="de" data-data='{"image": "{{URL::asset('assets/images/flags/de.svg')}}"}'>CMS.New - Loss</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-3">
                                ...
                                <table class="table table-bordered text-nowrap border border-1" id="example1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th  class="wd-15p border-bottom-0">Format</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td align="right"><i>
                                                    <font color="blue">857,120.13</font>
                                                </i></td>
                                            <td colspan="3"><i>Bring forward</i></td>
                                        </tr>
                                        <tr>
                                            <td colspan="3">
                                                <hr>
