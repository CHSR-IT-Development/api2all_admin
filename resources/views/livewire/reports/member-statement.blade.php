...
<div>
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title">Member Statement</h4>
        </div>
        <div class="page-rightheader ml-auto d-lg-flex d-none">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Member Statement</a></li>
            </ol>
        </div>
    </div>
    <div class="row">
                                ...
                                <table class="table table-bordered text-nowrap border" id="example1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center wd-15p border-bottom-0">Type</th>
                                            <th class="text-center wd-15p border-bottom-0">Total</th>
                                            <th class="text-center wd-15p border-bottom-0">Comm</th>
                                            <th class="text-center wd-15p border-bottom-0">Running Total</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
