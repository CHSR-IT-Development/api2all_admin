...
<div>
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title">Top Win Ticket</h4>
        </div>
        <div class="page-rightheader ml-auto d-lg-flex d-none">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Top Win Ticket</a></li>
            </ol>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="form-group mt-4">
                                <select name="country" id="select-countries" class="form-control custom-select select2">
                                    ...
                                    <option value="de" data-data='{"image": "{{URL::asset('assets/images/flags/de.svg')}}"}'>Sport</option>
                                    <option value="de" data-data='{"image": "{{URL::asset('assets/images/flags/de.svg')}}"}'>Live Casino</option>
