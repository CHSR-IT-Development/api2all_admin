    ...
    <div class="page-header">
        ...
        <div class="page-rightheader ml-auto d-lg-flex d-none">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Performance Report</a></li>
            </ol>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="form-group mt-4">
                                <select name="country" id="select-countries" class="form-control custom-select select2">
                                    ...
                                    <option value="br" data-data='{"image": "{{URL::asset('assets/images/flags/br.svg')}}"}'>Sport</option>
                                    <option value="cz" data-data='{"image": "{{URL::asset('assets/images/flags/cz.svg')}}"}'>Live Casino</option>
                                    <option value="de" data-data='{"image": "{{URL::asset('assets/images/flags/de.svg')}}"}'>Lottery</option>
                                    <option value="de" data-data='{"image": "{{URL::asset('assets/images/flags/de.svg')}}"}'>Games</option>
                                    <option value="de" data-data='{"image": "{{URL::asset('assets/images/flags/de.svg')}}"}'>P2P</option>
                                    <option value="de" data-data='{"image": "{{URL::asset('assets/images/flags/de.svg')}}"}'>Financial</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-3">
                            <div class="form-group mt-4">
                                <select name="country" id="select-countries" class="form-control custom-select select2">
                                    <option value="pl" data-data='{"image": "{{URL::asset('assets/images/flags/pl.svg')}}"}' selected>All</option>
                                    <option value="br" data-data='{"image": "{{URL::asset('assets/images/flags/br.svg')}}"}'>M-sports</option>
                                    <option value="cz" data-data='{"image": "{{URL::asset('assets/images/flags/cz.svg')}}"}'>S-sports</option>
                                    <option value="de" data-data='{"image": "{{URL::asset('assets/images/flags/de.svg')}}"}'>la E-sports</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-12 ">
                            <button type="submit" class="btn btn-success mb-0 mr-3 mt-4">Submit</button>
                            ...
                            <button type="submit" class="btn btn-success mb-0 mr-3 mt-4">Export</button>
                        </div>
