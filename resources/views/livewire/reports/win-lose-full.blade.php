                        ...
                        <div class="col-12">
                            <div class="table-responsive">
                                <table class="table table-bordered text-nowrap border border-1" id="example1">
                                    <thead>
                                        <tr>
                                            <th class="text-center color-title" rowspan="2" style="vertical-align: inherit;">Username</th>
                                            <th class="text-center color-title" rowspan="2" style="vertical-align: inherit;">TurV.Amt</th>
                                            <th colspan="4" class="text-center color-0"><p>PLY</p></th>
                                            <th colspan="4" class="text-center color-1"><p>AG</p></th>
                                            <th colspan="4" class="text-center color-0"><p>MA</p></th>
                                            <th colspan="4" class="text-center color-1"><p>SR</p></th>
                                            <th colspan="4" class="text-center color-0"><p>SSR</p></th>
                                            <th class="text-center color-1" rowspan="2" style="vertical-align: inherit;">Company</th>
                                        </tr>
                                        <tr class="winlose-full__thead">
                                            <th class="text-center color-0">Win</th>
                                            <th class="text-center color-0">Comm</th>
                                            <th class="text-center color-0">Loyalty</th>
                                            <th class="text-center color-0">Total</th>
                                            <th class="text-center color-1">Win</th>
                                            <th class="text-center color-1">Comm</th>
                                            <th class="text-center color-1">Loyalty</th>
                                            <th class="text-center color-1">Total</th>
                                            <th class="text-center color-0">Win</th>
                                            <th class="text-center color-0">Comm</th>
                                            <th class="text-center color-0">Loyalty</th>
                                            <th class="text-center color-0">Total</th>
                                    ...
                                    <tbody>
                                        <tr style="font-weight:bold">
                                            ...
                                            <td class="text-right color-0"></td>
                                            <td class="text-right color-0"></td>
                                            <td class="text-right color-0"></td>
                                            <td class="text-right color-0"></td>
                                            <td class="text-right color-1"></td>
                                            <td class="text-right color-1"></td>
                                            <td class="text-right color-1"></td>
                                            <td class="text-right color-1"></td>
                                            <td class="text-right color-0"></td>
                                            ...
                                            <td class="text-right color-1"></td>
                                            <td class="text-right color-1"></td>
                                            <td class="text-right color-0 warning"></td>
                                            <td class="text-right color-0 warning"></td>
                                            <td class="text-right color-0 warning"></td>
                                            <td class="text-right color-0 warning"></td>
