...
<div>
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title">Member Action Logs</h4>
        </div>
        <div class="page-rightheader ml-auto d-lg-flex d-none">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Member Action Logs</a></li>
            </ol>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <select name="country" id="select-countries" class="form-control custom-select select2">
                                    ...
                                    <option value="br" data-data='{"image": "{{URL::asset('assets/images/flags/br.svg')}}"}'>View Info</option>
                                    <option value="cz" data-data='{"image": "{{URL::asset('assets/images/flags/cz.svg')}}"}'>Login</option>
                                    <option value="de" data-data='{"image": "{{URL::asset('assets/images/flags/de.svg')}}"}'>Create Member</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-4">
                        ...
                        <div class="col-12">
                            <div class="table-responsive">
                                <table class="table table-bordered text-nowrap" id="example1">
                                    <thead>
                                        <tr>
                                            <th class="text-center wd-15p border-bottom-0" width="70">No.</th>
                                            <th width="150" class="wd-15p border-bottom-0">Action Time</th>
                                            <th width="150" class="wd-15p border-bottom-0">Created Time</th>
                                            <th width="150" class="wd-15p border-bottom-0">Action By</th>
                                            <th width="170" class="wd-15p border-bottom-0">IP</th>
                                            <th width="150" class="wd-15p border-bottom-0">Affected User</th>
                                            <th width="120" class="wd-15p border-bottom-0">Type</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>2023-10-06 11:57:03</td>
                                            <td>-</td>
                                            <td>test@ma00</td>
                                            <td>51.195.140.214</td>
                                            <td>test@ma00</td>
                                            <td>Login</td>
                                            <td>test@ma00 Login. success</td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            <td>2023-10-06 09:26:44</td>
                                            <td>-</td>
                                            <td>test@ma00</td>
                                            <td>51.195.140.214</td>
                                            <td>test@ma00</td>
