...
<div>
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title">Cash Withdraw List</h4>
        </div>
        <div class="page-rightheader ml-auto d-lg-flex d-none">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Cash Withdraw List</a></li>
            </ol>
        </div>
    </div>
    <div class="row">
                        ...
                        <table class="table table-bordered text-nowrap" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th>Account ID</th>
                                    <th>Type<i class="fa fa-question-circle tooltip-name-label" data-html="true" data-placement="bottom" data-toggle="tooltip" data-original-title="Succeed Txn: Approved transaction per day"></i></th>
                                    <th>Bank</th>
                                    <th>Bank Account No</th>
                                    <th>Currency</th>
                                    <th>Amount</th>
                                    <th>Status</th>
                                    <th>Auto Process In</th>
                                    <th>Remarks</th>
                                    <th>Created Date</th>
